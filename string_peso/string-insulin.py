...
preproInsulin = "malwmrllpllallalwgpdpaaafvnqhlcgshlvealylvcgergffytpktr"  or  "reaedlqvgqvelgggpgagslqplalegslqkrgiveqcctsicslyqlenycn"
...
# Imprimindo no console usando strings concatenadas dentro da função de impressão (one-liner):
